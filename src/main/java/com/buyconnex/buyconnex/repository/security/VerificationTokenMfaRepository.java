...
public interface VerificationTokenMfaRepository extends JpaRepository<VerificationTokenMfa, Long> {
    ...
    public Optional<VerificationTokenMfa> findByMfaCode(String otp);

    public Optional<VerificationTokenMfa> findByUsers(Users users);

    @Transactional
    public void deleteAllByUsers(Users users);
